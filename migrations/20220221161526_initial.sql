...
CREATE INDEX action_receipts_included_in_block_hash_idx ON action_receipts USING btree (included_in_block_hash);
CREATE INDEX action_receipts_included_in_chunk_hash_idx ON action_receipts USING btree (included_in_chunk_hash);
CREATE INDEX action_receipts_predecessor_account_id_idx ON action_receipts USING btree (predecessor_account_id);
CREATE INDEX action_receipts_receiver_account_id_idx ON action_receipts USING btree (receiver_account_id);
CREATE INDEX action_receipts_timestamp_idx ON action_receipts USING btree (included_in_block_timestamp);
CREATE INDEX action_receipts_originated_from_transaction_hash_idx ON action_receipts (originated_from_transaction_hash);
CREATE INDEX data_receipts_included_in_block_hash_idx ON data_receipts USING btree (included_in_block_hash);
CREATE INDEX data_receipts_included_in_chunk_hash_idx ON data_receipts USING btree (included_in_chunk_hash);
CREATE INDEX data_receipts_predecessor_account_id_idx ON data_receipts USING btree (predecessor_account_id);
CREATE INDEX data_receipts_receiver_account_id_idx ON data_receipts USING btree (receiver_account_id);
CREATE INDEX data_receipts_timestamp_idx ON data_receipts USING btree (included_in_block_timestamp);
CREATE INDEX data_receipts_originated_from_transaction_hash_idx ON data_receipts (originated_from_transaction_hash);
